...
public class PizzaMemDao implements IPizzaDao {
	...
	public PizzaMemDao() {
		...
		listeDesPizzas.add(new Pizza(0, "PEP", "Pépéroni", 12.50));
		listeDesPizzas.add(new Pizza(1, "MAR", "Margherita", 14.00));
		listeDesPizzas.add(new Pizza(2, "REIN", "La Reine", 11.50));
		listeDesPizzas.add(new Pizza(3, "FRO", "La 4 fromage", 12.00));
		listeDesPizzas.add(new Pizza(4, "CAN", "La cannibale", 12.50));
		listeDesPizzas.add(new Pizza(5, "SAV", "La savoyarde", 13.00));
		listeDesPizzas.add(new Pizza(6, "ORI", "L'orientale", 13.50));
		listeDesPizzas.add(new Pizza(7, "IND", "L'indienne", 14.00));
	}
